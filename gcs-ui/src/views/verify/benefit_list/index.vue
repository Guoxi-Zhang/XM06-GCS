<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handlePass"
          v-hasPermi="['verify:verify_history:pass']"
        >通过</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleDeny"
          v-hasPermi="['verify:verify_history:deny']"
        >不通过</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleReject"
          v-hasPermi="['verify:verify_history:reject']"
        >驳回</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
    ...
    <el-table v-loading="loading" :data="benefit_applyList" @selection-change="handleSelectionChange">
      <el-table-column type="selection" width="55" align="center" v-if="2===nowStep"/>
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button
            ...
            type="text"
            icon="el-icon-edit"
            v-hasPermi="['benefit:benefit_apply:detail']"
          >
...
<script>
import { getBenefitVerifyList } from "@/api/verify/benefit_list";
