<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="pack_applyList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="申请礼包id" align="center" prop="packId" />
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button
            ...
            type="text"
            icon="el-icon-edit"
            v-hasPermi="['verify:pack_list:detail']"
          >
            <router-link :to="'/verify/pack_list/verify_list/' + scope.row.tableId">
              <span>查看</span>
            </router-link>
          </el-button>
        </template>
...
<script>
import { getPackVerifyList, addPackVerifyByApplyIds } from "@/api/verify/pack_list";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      getPackVerifyList(this.queryParams).then(response => {
